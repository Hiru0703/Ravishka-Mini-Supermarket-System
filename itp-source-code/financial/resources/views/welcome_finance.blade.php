        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Financial Services</h2>
                    <h3 class="section-subheading text-muted">Lead a comfortable life, take care of your finances..</h3>
                </div>
                <div class="row text-center">
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <a href="/statement"><i class="fas fa-circle fa-stack-2x text-success"></i></a>
                            <a href="/statement"><i class="fas fa-shopping-cart fa-stack-1x fa-inverse"></i></a>
                        </span>
                        <h4 class="my-3">Income Statement</h4>
                        <p class="text-muted">Represents revenue for the goods sold or services provided during a given period of time.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <a href="/exstate"><i class="fas fa-circle fa-stack-2x text-success"></i></a>
                            <a href="/exstate"><i class="fas fa-laptop fa-stack-1x fa-inverse"></i></a>
                        </span>
                        <h4 class="my-3">Expenditure Statement</h4>
                        <p class="text-muted">An expenditure is defined as the purchase of goods or services that are expected to have an economic benefit during a specified period.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <a href="/report"><i class="fas fa-circle fa-stack-2x text-success"></i></a>
                            <a href="/report"><i class="fas fa-lock fa-stack-1x fa-inverse"></i></a>
                        </span>
                        <h4 class="my-3">Report Statement</h4>
                        <p class="text-muted">A financial statement is a written record of the activities and financial performance of a company during a set period.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                ...
                <img src="logo.png" class="" alt="supermarket" style="width:150px; height:150px">
                    <h3 class="section-subheading text-muted">Ravishka Mini-Supermarket</h3>
                </div>
        </section>
        <!-- Bootstrap core JS-->
