...
<html lang="en">
  ...
  <main role="main">
    ...
    <br><br>
      <div class="title">
          <h2><center>Profit Statement for the period ending December 31,2022</center></h2>
          <br>
      ...
      <form style="width:1400px" method = "post" action="{{ route('profitsaveTask.store') }}">   
        {{csrf_field()}}  
      ...
      <table class="table table-hover" style="margin-left:250px">
        <thead>
            <tr>
                <th scope="col"><h3 style="color:green">Revenue</h3></th>
                <th scope="col"></th>
                <th scope="col"></th>
                <th scope="col"></th>
            </tr>
        ...
        <tbody>
            <tr>
                <th scope="row"><h4>Customer Income</h4></th>                    
                <td style="font-size: 30px">{{$CustomerIncome}}</td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <th scope="row"><h4>Sales Income</h4></th>
                <td style="font-size: 30px">{{$SalesIncome}}</td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <th scope="row"><h4>Interest Income</h4></th>
                <td style="font-size: 30px">{{$InterestIncome}}</td>
                <td></td>
                <td></td>
            </tr>
        <thead>    
            <tr>
                <th scope="row"><h4 style="color:#64DD17">Total Incomes</h4></th>
                <th></th>
                <th><input class="border-0" style="color: green; font-size: 35px; text-align: center; font-style: italic"type="text" name="total_income" value="{{$totalIncomes}}" readonly></th> 
            </tr>
            <tr>
                <th scope="col"><h3 style="color:green">Expenses</h3></th>
                <th scope="col"></th>
                <th scope="col"></th>
                <th scope="col"></th> 
            </tr>    
            ...
            <tr>
                <th scope="row"><h4>Employee Payments</h4></th>
                <td style="font-size: 30px">{{$EmployeePayments }}</td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <th scope="row"><h4>Electricity Payments</h4></th>
                <td style="font-size: 30px">{{$ElectricityPayments }}</td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <th scope="row"><h4>Supplier Payments</h4></th>
                <td style="font-size: 30px">{{$SupplierPayments }}</td>
                <td></td>
                <td></td>
            </tr> 
            <tr>
                <th scope="row"><h4>Other Utility Bills</h4></th>
                <td style="font-size: 30px">{{$OtherUtilityBills }}</td>
                <td></td>
                <td></td>
            </tr> 
        <thead>    
            <tr>
                <th scope="row"><h4 style="color:#64DD17">Total Expenses</h4></th>
                <th></th>
                <th><input class="border-0" style="color: green; font-size: 35px; text-align: center; font-style: italic" type="text" name="total_expense" value="{{$TotalExpenses}}" readonly></th>
                <th><input type="submit" class="btn btn-success btn-lg" value="ADD"></th>
            </tr> 
            <tr>
                <th scope="row"><h4 style="color:#18FFFF">Net Profit</h4></th>
                <th></th>
                <th><input class="border-0" style="color: #AFB42B; font-size: 35px; text-align: center; font-style: italic; text-decoration: underline" type="text" name="net_profit" value="{{$totalIncomes - $TotalExpenses}}" readonly></th>
            </tr> 
        </thead>        
        </tbody>
    </table>
    ...
    <div class="row justify-content-around">
        ...
        <div class="col-md-5"> 
            <a href="/report" class="text-decoration-none text-right"><h3>Next ></h3></a>
        </div> 
    </div>
