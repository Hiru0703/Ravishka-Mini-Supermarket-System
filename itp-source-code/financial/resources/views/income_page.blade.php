...
<html lang="en">
  ...
  <!--header-->
    ...
    <br><br>
      <div class="title">
          <h2><center>Income Page</center></h2>
          <br>
        ...
        <div class="row justify-content-around">
          ...
          <label for="incomeTitle" class="col-sm-2 col-form-label"><h5>Type of Income</h5></label>
            ...
            <div class="col-md-2 mb-5">
              <!--view type of income-->
              <input type="text" class="form-control form-control-lg" name="income1" value= "{{ $post->type_of_income}}" readonly>
            </div>
             @endforeach
                ...
                <label for="incomeID" class="col-sm-2 col-form-label"><h5>Income ID</h5></label>
                    ...
                    <div class="col-md-2 mb-5">
                        <!--view income id-->
                        <input type="text" class="form-control form-control-lg" name="incomeid1" value= "{{
                            $post->income_id
                        }}" readonly>
                    </div>
                    @endforeach
                ...
                <div class="row justify-content-around">
                    ...
                    <label for="incomeDate" class="col-sm-2 col-form-label"><h5>Income Date</h5></label>
                        ...
                        <div class="col-md-2 mb-5"> 
                            <!--view income date-->
                            <input type="text" class="form-control form-control-lg" name="idate1" value= "{{
                                $post->i_date
                        }}" readonly>          
                        </div> 
                        @endforeach
                    ...
                    <div class="row justify-content-around">
                        ...
                        @foreach ($posts as $post)
                            <div class="col-md-2 mb-5">
                                <!--view monthly income-->
                                <input type="text" class="form-control form-control-lg" name="monthincome1" value= "{{
                                    $post->month_income
                            }}" readonly>

                            <br><br>

                                <a class="btn btn-success btn-lg" href="{{'update/'.$post->income_id }}" role="button"|>UPDATE</a>   
                                <a class="btn btn-primary btn-lg" href="{{'idelete/'.$post->income_id }}" role="button"|>DELETE</a>
            ...
            <br><br>
              <a href="incomepie" class="link-dark text-decoration-none text-center"><h2>View Monthly Income Pie Chart</h2></a>
            ...
            <br> <br> <br>
              ...
              <div class="row justify-content-around">
                <div class="col-md-2">
                  <a href="/statement" class="text-decoration-none text-left"><h3>< Back</h3></a>
                </div>   
                <div class="col-md-5"> 
                  <a href="/exstate" class="text-decoration-none text-right"><h3>Next ></h3></a>
              </div> 
            </div>
