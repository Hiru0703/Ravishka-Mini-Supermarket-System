...
<div class="wrapper">
    ...
    <form action="#">
      ...
      <p>job role</p>
  <input type="radio" id="Driver" name="job role" value="Driver">
  <label for="html">Driver</label><br>
  <input type="radio" id="stock manger" name="job role" value="stock manger">
  <label for="css">stock manger</label><br>
  <input type="radio" id="shop keeper" name="job role" value="shop keeper">
