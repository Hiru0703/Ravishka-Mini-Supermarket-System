...
<div class="wrapper">
    ...
    <form method="POST" action="{{ route('register') }}">
      ...
      <p>job role</p>
  <input type="radio" id="Driver" name="jobrole" value="Driver">
  <label for="html">Driver</label><br>
  <input type="radio" id="stock manger" name="jobrole" value="stock manger">
  <label for="css">stock manger</label><br>
  <input type="radio" id="shop keeper" name="jobrole" value="shop keeper">
